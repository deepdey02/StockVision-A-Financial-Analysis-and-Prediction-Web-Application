...
def calculate_beta(stock_ticker, market_ticker="^GSPC", period="1y"):
    # Download stock and market data
    stock = yf.download(stock_ticker, period=period)["Close"]
    market = yf.download(market_ticker, period=period)["Close"]
